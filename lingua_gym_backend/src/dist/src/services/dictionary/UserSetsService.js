...
let UserSetsService = class UserSetsService {
    constructor(model) {
    ...
    addUserSet(userId, setId, permission) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this.userSetsModel.addUserToSet(userId, setId, permission);
            }
            catch (error) {
    ...
    removeUserSet(userId, setId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this.userSetsModel.removeUserFromSet(userId, setId);
            }
            catch (error) {
    ...
    getUserSets(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this.userSetsModel.getUserSets(userId);
            }
            catch (error) {
    ...
    getUsersForSet(setId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this.userSetsModel.getUsersBySet(setId);
            }
            catch (error) {
...
UserSetsService = __decorate([
    injectable(),
    __metadata("design:paramtypes", [UserSetsModel])
], UserSetsService);
