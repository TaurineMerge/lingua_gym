...
container.register('UserModel', { useValue: new UserModel(db) });
container.register('UserMetadataModel', { useValue: new UserMetadataModel(db) });
container.register('UserPasswordResetModel', { useValue: new UserPasswordResetModel(db) });
