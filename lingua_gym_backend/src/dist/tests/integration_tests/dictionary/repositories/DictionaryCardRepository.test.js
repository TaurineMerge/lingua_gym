...
describe('DictionaryCardModel integration', () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        testCardId = yield cardRepository.createCard(Object.assign(Object.assign({}, card), { translations, meanings, examples }));
    }));
    ...
    test('should create and retrieve card with all related data', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield cardRepository.getCardById(testCardId);
    ...
    test('should update card data completely', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const isUpdated = yield cardRepository.updateCard(testCardId, updatedData, updatedTranslations, updatedMeanings, updatedExamples);
    ...
    test('should completely remove card with all related data', () => __awaiter(void 0, void 0, void 0, function* () {
        const isRemoved = yield cardRepository.removeCardById(testCardId);
