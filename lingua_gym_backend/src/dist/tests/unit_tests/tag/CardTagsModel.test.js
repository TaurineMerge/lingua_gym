...
describe('CardsTagsModel', () => {
    ...
    beforeEach(() => {
        ...
        cardTagsModel = new CardTagsModel(mockDb);
        mockCards = [
    ...
    test('addTagToCard - should return true when tag is added', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield cardTagsModel.addTagToCard(mockCards[0].dictionaryCardId, mockTags[0].tagId);
    ...
    test('removeTagFromCard - should return true when tag is removed', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield cardTagsModel.removeTagFromCard(mockCards[0].dictionaryCardId, mockTags[0].tagId);
    ...
    test('getTagsForCard - should return list of tags', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield cardTagsModel.getTagsForCard(mockCards[0].dictionaryCardId);
